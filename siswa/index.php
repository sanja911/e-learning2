	...
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Halaman</span>Siswa</a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				<div class="profile-usertitle-name"><?php echo $data['nama'];?></div>
		...
		<ul class="nav menu">
			...
			<li><a href="widgets.html"><em class="fa fa-calendar">&nbsp;</em>Tugas</a></li>
			<li><a href="charts.html"><em class="fa fa-bar-chart">&nbsp;</em>Nilai</a></li>
			<li><a href="comp/logout.php"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
		</ul>
	</div><!--/.sidebar-->
