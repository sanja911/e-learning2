		...
		<ul class="nav menu">
			...
			<li class="parent"><a data-toggle="collapse" href="#sub-item-1">
				...
				<ul class="children collapse" id="sub-item-1">
					...
					<li><a class="active" href="nilai.php">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
				   <div class="panel-heading">Nilai Kelas <?php echo $data['kelas'];?>
					...
					<div class="modal-content abt-w3l">
						...
						echo "</div>";
							...
							<div class="form-group">
									...
									<textarea class="form-control" rows="3" name="judul_soal" onkeyup="this.value = this.value.toUpperCase()"></textarea>
								</div>
