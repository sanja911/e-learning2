...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <br></br>        
		<table id="data" class="table table-bordered table-striped table-scalable" border="0">
						<?php 
						$id=$_GET['id'];
						$modal=mysql_query("SELECT * FROM soal JOIN jawaban ON soal.id = jawaban.kode_mapel WHERE id='$id'");
					...
					<div class="modal-content abt-w3l">
						...
						echo "</div>";
							...
							<div class="form-group"><label>Nama Guru</label>
								<input class="form-control" placeholder="NIS" name="id" type="text" autofocus="" minlength="8" maxlength="8" value=<?php echo $data['nama'];?> readonly required >
							</div>
