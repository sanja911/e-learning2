		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
				   <div class="panel-heading">Daftar Siswa Kelas <?php echo $data['kelas'];?>
					...
					<div class="modal-content abt-w3l">
						...
						<fieldset>
							...
							<div class="form-group"><label>NIS</label>
								<input class="form-control" placeholder="NIS" name="id" type="text" autofocus="" minlength="7" maxlength="8" required >
							</div>
							<div class="form-group"><label>Nama</label>
								<input class="form-control" placeholder="Nama" name="nama" type="text" autofocus="" minlength="8" maxlength="16" onkeyup="this.value = this.value.toUpperCase()" required>
							</div>
