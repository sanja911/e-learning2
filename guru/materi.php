	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<?php
							...
							$sql2="select * from soal where nip='$nip'";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
				   <div class="panel-heading">SOAL KELAS <?php echo $data['kelas'];?> MAPEL <?php echo $data2['mapel'];?>
				   <div align="right"></div></div>
					...
					<?php 
						...
						$data  = mysql_fetch_array($hasil);
					?>
		<?php echo "<form action='comp/add_materi.php?id=$data[id]' method='post'>"?>
		<button name="submit" class="btn btn-success" data-toggle="modal"><i class="fa fa-plus"></i>Simpan</button></a>
       	<br></br>
	<br />
	<label>Kode Soal </label>
	<input type="text" name="id" placeholder="Kode Soal" class="form-control" value="<?php echo $data['id'];?>"disabled/><br/>  	
    <br />
	<label>Judul Soal </label>
	<input type="text" id="cek" name="judul_soal" placeholder="Judul" class="form-control" value="<?php echo $data['judul_soal'];?>"disabled /><br />
    <br />
	<label>Soal</label>
	<textarea class="form-control" rows="3" name="soal" onkeyup="this.value = this.value.toUpperCase()"><?php echo $data['soal'];?></textarea>
	<br />
	<br />
	<label>Jawaban</label>
	<textarea class="form-control" rows="3" name="kunci" onkeyup="this.value=this.value.toUpperCase()"><?php echo $data['kunci'];?></textarea>
	<br />
	</div>
   	</form>   
	<script type="text/javascript">
    ...
    function verify(){
	 ...
	 <?php
						$id=$_GET['id'];
						$query =mysql_query( "select * from soal where id='$id'");
						if($query == false){
				...
				<!-- Modal content-->
					...
					<div class="modal-content abt-w3l">
						...
						echo "</div>";
							...
							<div class="form-group">
									<label>Judul Soal</label>
									<input class="form-control" rows="3" name="judul_soal" type="text"></textarea>
								</div>
